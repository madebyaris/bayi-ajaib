            ...
            <div className="relative">
              ...
              <div className="mt-6 space-y-6">
                <blockquote className="rounded-2xl bg-neutral-900 ring-1 ring-neutral-800 p-4">
                  <p className="text-neutral-200">"Vibe sent three profiles that were better than our entire inbound in months. We signed our Staff FE in two weeks."</p>
                ...
                <blockquote className="rounded-2xl bg-neutral-900 ring-1 ring-neutral-800 p-4">
                  <p className="text-neutral-200">"The embedded model is the first time recruiting felt like product work—fast iteration, tight feedback, strong outcomes."</p>
                  <footer className="mt-3 flex items-center gap-3">
                    <span className="relative w-8 h-8 rounded-full overflow-hidden ring-1 ring-neutral-800">
